    ...
    (set, get) => ({
      ...
      runScan: async () => {
        ...
        try {
          ...
          let stratEval: ((sym: string, candles: any[]) => any) | undefined;
          if (s.scanStrategyId) {
            ...
            if (strat) {
                ...
                // Minimal inline eval — reuses the same logic as BacktestPanel's snap builder
                if (candles.length < 30) return null;
                const last = candles[candles.length - 1];
                let e9: number | null = null, e20: number | null = null, e50: number | null = null;
                for (const c of candles) {
                    e9  = e9  === null ? c.c : c.c * (2/10)  + e9  * (1 - 2/10);
                    e20 = e20 === null ? c.c : c.c * (2/21)  + e20 * (1 - 2/21);
                    e50 = e50 === null ? c.c : c.c * (2/51)  + e50 * (1 - 2/51);
                }
                const bull = e9 && e20 && e50 && e9 > e20 && e20 > e50;
                const bear = e9 && e20 && e50 && e9 < e20 && e20 < e50;
